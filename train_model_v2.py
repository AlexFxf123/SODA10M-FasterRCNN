...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='models_split_v2/faster_rcnn_best.pth',
                       help='从指定的模型文件恢复训练 (默认: models_split_v2/faster_rcnn_best.pth)')
    ...
    config = {
        ...
        # 输出路径
        'model_save_dir': 'models_split_v2',
        'results_save_dir': 'results_split_v2',
