...
def get_faster_rcnn_model(num_classes, pretrained=True):
    ...
    model = fasterrcnn_resnet50_fpn_v2(pretrained=False, min_size=1080, max_size=1920)
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='models_export_v2/faster_rcnn_best.pth',
                       help='从指定的模型文件恢复训练 (默认: models_export_v2/faster_rcnn_best.pth)')
    ...
    config = {
        ...
        'val_ratio': 0.2,    # 验证集比例
        'random_seed': 42,   # 随机种子，每次随即划分结果完全相同
        ...
        # 输出路径
        'model_save_dir': 'models_export_v2',
        'results_save_dir': 'results_export_v2',
